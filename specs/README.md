...
| [0010](0010-identity.md)             | Identity — usuários, autenticação e RBAC                    | draft       |

Specs de domínio planejadas (ainda não escritas): `0011` accounts (F002) · `0012` expenses (F003) · `0013` statements (F004) · `0014` earnings (F005) · `0015` reporting · `0016` imports.
