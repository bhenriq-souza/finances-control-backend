...
| [0003](0003-persistence.md)          | Persistência — PostgreSQL, TypeORM e migrations             | approved |

Specs de domínio planejadas (ainda não escritas): `0010` identity (F001) · `0011` accounts (F002) · `0012` expenses (F003) · `0013` statements (F004) · `0014` earnings (F005) · `0015` reporting · `0016` imports.
