...
7. **Dinheiro nunca é ponto flutuante** (INV-0000-04). Persistir em `numeric(14,2)`; representar em TypeScript como inteiro de centavos, sempre convertido pelo `moneyTransformer` da plataforma (spec 0003) — jamais `number` com fração.
